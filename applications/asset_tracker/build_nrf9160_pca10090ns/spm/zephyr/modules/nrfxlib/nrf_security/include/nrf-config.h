 ...
 *
 */
#define MBEDTLS_AES_ALT // - depends on backend configuration
...
//#define MBEDTLS_ECDH_GEN_PUBLIC_ALT - depends on backend configuration
//#define MBEDTLS_ECDH_COMPUTE_SHARED_ALT - depends on backend configuration
//#define MBEDTLS_ECDSA_VERIFY_ALT - depends on backend configuration
//#define MBEDTLS_ECDSA_SIGN_ALT - depends on backend configuration
//#define MBEDTLS_ECDSA_GENKEY_ALT - depends on backend configuration
